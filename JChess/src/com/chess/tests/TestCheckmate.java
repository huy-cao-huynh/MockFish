...
public class TestCheckmate {
    ...
    public void testMateInTwoTest1() {
        ...
        final MoveStrategy alphaBeta = new MiniMax(4); // TODO switch after implementing alpha-beta
    ...
    public void testMateInTwoTest3() {
        ...
        final MoveStrategy alphaBeta = new MiniMax(1); // TODO switch after implementing alpha-beta
        final Move bestMove = alphaBeta.execute(board);
        assertEquals(bestMove, Move.MoveFactory
